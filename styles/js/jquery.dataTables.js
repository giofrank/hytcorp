	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='ver'>Ver</span><span class='menu'> _MENU_ </span><span class='entradas'>entradas</span>",
				"sZeroRecords": "No se encontro ninguna refencia del articulo buscado",
				"sEmptyTable": "No data available in table",
				"sLoadingRecords": "Cargando...",
				"sInfo": "Pagina _START_ de _END_ de _TOTAL_ entradas",
				"sInfoEmpty": "Showing 0 to 0 of 0 entries",
				"sInfoFiltered": "(filtered from _MAX_ total entries)",
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "<span class='ingresar'>Buscar</span>:",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "Primero",
					"sPrevious": "Anterior",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<span class="ingresar"><input type="text" class="form-control col-md-8 ingresar" placeholder="Ingrese descripcion del articulo a buscar"/></span>') :
			  sSearchStr==="" ? '<span class="ingresar"><input type="text" class="form-control ingresar col-md-8 " placeholder="Ingrese descripcion del articulo a buscar"/></span>' : sSearchStr+' <span class="ingresar"><input  type="text" class="col-md-8 form-control ingresar" placeholder="Ingrese descripcion del articulo a buscar"/></span>';
